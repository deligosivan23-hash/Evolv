  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-8">
      ...
      {section('Plan', <>
        ...
        {row('Evolv Pro', 'Unlimited goals, habits, analytics & more', <button style={{ color: BRAND }} className="text-sm font-medium hover:opacity-70 transition-opacity">Coming Soon</button>)}
      </>)}
