...
export interface HabitLog {
  ...
  rating?: number;
  reflection: string;
  // Optional: the user's custom daily target override when this log was saved
  dailyTargetUsed?: number;
  // Whether this log was auto-recorded when the timer hit the target
